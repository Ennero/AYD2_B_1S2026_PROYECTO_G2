...
*¿Qué hice ayer?*
- Terminar con los drivers de restricción, de calidad, RF, RNF y requerimientos arquitecturales

*¿Qué voy a hacer hoy?*
- Comenzar a realizar las características del sistema priorizado, diagrama de casos de uso, matrices de trazabilidad y el listado de stakeholders y preocupaciones arquitectónicas
...
*¿Qué hice ayer?*
- Terminar el diagrama de contexto

*¿Qué voy a hacer hoy?*
- Comenzar con los mockups

*¿Tengo algún impedimento?*
- No sabía cómo hacerlo, pero investigando lo logró entender
...
*¿Qué hice ayer?*
- Comenzar con la justificación del diseño arquitectónico

*¿Qué voy a hacer hoy?*
- Arreglar conforme se vaya planeando la arquitectura y comenzar con los mockups
...
*¿Qué hice ayer?*
- Terminar de leer el proyecto, avanzar en el diagrama de bloques y hacer la base de los mockups para el registro de transportes

*¿Qué voy a hacer hoy?*
- Terminar el diagrama de bloques

*¿Tengo algún impedimento?*
- Falta de tiempo por los parciales
...
*¿Qué hice ayer?*
- Comenzar con el diagrama de despliegue, leer y entender el proyecto

*¿Qué voy a hacer hoy?*
- Terminar el diagrama de despliegue
...
*¿Qué hice ayer?*
- Terminar de leer el enunciado y la documentación realizada, trabajar en el diagrama de componentes y definir los estilos de los mockups para que todos tengan el mismo estilo

*¿Qué voy a hacer hoy?*
- Seguir con los mockups
...
**Resumen del Daily:**
El equipo está trabajando en paralelo en la documentación arquitectónica y los primeros mockups del sistema. Enner está cerrando los documentos del DDA, mientras el resto del equipo avanza en diagramas (contexto, bloques, despliegue, componentes) y mockups. Henry definió los estilos visuales base para mantener consistencia en los mockups. Dos miembros reportaron limitaciones de tiempo por parciales universitarios.

**Notas Importantes:**
- Henry estableció los estilos y guía visual para que todos los mockups sean consistentes
- Marcos tuvo que investigar el formato del diagrama de contexto por cuenta propia antes de completarlo
- Se identificó presión de tiempo por parciales en Anyelo y Pablo — a tomar en cuenta para el ritmo del sprint
- El DDA está siendo cerrado por Enner en paralelo con el avance del resto del equipo
