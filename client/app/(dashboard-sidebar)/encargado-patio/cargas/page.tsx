    ...
    <div className="min-h-screen" style={{ background: "#F5F2EC" }}>
      ...
      <div className="relative z-10 max-w-5xl mx-auto px-8 py-10">
        ...
        <motion.div initial={{ opacity: 0, y: 8 }} animate={{ opacity: 1, y: 0 }}
          ...
          style={{
            background: "#1E1E1B", borderRadius: "8px", padding: "1rem 1.25rem",
            marginBottom: "1.75rem", display: "flex", flexWrap: "wrap", alignItems: "center", gap: "0 2rem",
          }}>
          ...
          <div style={{ display: "flex", gap: "1rem", alignItems: "center" }}>
            {(["asc", "desc"] as const).map(v => (
              <button key={v} onClick={() => setOrden(v)}
                style={{ fontSize: "0.65rem", letterSpacing: "0.08em", cursor: "pointer", fontWeight: orden === v ? 700 : 400, color: orden === v ? "#C9924B" : "rgba(245,242,236,0.3)", transition: "color 0.15s", background: "none", border: "none" }}>
                {v === "asc" ? "↑ ASC" : "↓ DESC"}
              </button>
            ))}
          </div>
          ...
          <button onClick={clearFilters}
            style={{ marginLeft: "auto", display: "flex", alignItems: "center", gap: "4px", fontSize: "0.6rem", color: "rgba(245,242,236,0.25)", cursor: "pointer", letterSpacing: "0.08em", transition: "color 0.15s", background: "none", border: "none" }}
              ...
              <motion.div key={carga.id}
                ...
                <div style={{ padding: "1.25rem 1.5rem" }}>
                  ...
                  <div style={{ display: "flex", alignItems: "flex-start", gap: "2rem", flexWrap: "wrap" }}>
                    ...
                    {[
                      { label: "Piloto", value: carga.pilotName },
                  ...
                  <div style={{ display: "flex", alignItems: "center", gap: "2rem", flexWrap: "wrap" }}>
                    ...
                    <div style={{ minWidth: "80px" }}>
                      <Label>Unit ID</Label>
                      <p style={{ fontSize: "0.78rem", fontWeight: 600, color: carga.unitId ? "#0C0C0A" : "rgba(12,12,10,0.3)" }}>
                        {carga.unitId ?? "Sin asignar"}
                      </p>
                    </div>
                      ...
                      <div style={{ display: "flex", alignItems: "center", gap: "6px" }}>
                        <input
                          ...
                          style={{
                            ...
                            borderBottom: `1px solid ${done ? "rgba(12,12,10,0.06)" : "rgba(12,12,10,0.15)"}`,
                            fontSize: "0.82rem", fontWeight: 600, color: "#0C0C0A",
                            padding: "2px 0", outline: "none", textAlign: "center",
                            transition: "border-color 0.15s",
                          }}
                          onFocus={e => { if (!done) e.currentTarget.style.borderBottomColor = "#C9924B" }}
                          onBlur={e => e.currentTarget.style.borderBottomColor = done ? "rgba(12,12,10,0.06)" : "rgba(12,12,10,0.15)"}
                        />
                    ...
                    <div>
                      ...
                      <button type="button" disabled={done}
                        ...
                        style={{ display: "flex", alignItems: "center", gap: "6px", cursor: done ? "default" : "pointer", padding: "2px 0", background: "none", border: "none" }}>
                        {carga.estibaValida
