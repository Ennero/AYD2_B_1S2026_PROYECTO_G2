...
- **Usuario**: `2895884051401+ventas@ingenieria.usac.edu.gt` (Password: `seed$2895884051401+ventas@ingenieria.usac.edu.gt`)
...
- **Usuario**: `2895884051401+cliente1@ingenieria.usac.edu.gt` (O el correo plus-addressing que hayas asignado al cliente creado).
- **Acción**: 
...
- **Usuario**: `2895884051401+logistica@ingenieria.usac.edu.gt`
- **Acción**: Asigna un piloto y camión a la orden y ponla en estado de tránsito hacia patio.
- **Usuario**: `2895884051401+patio@ingenieria.usac.edu.gt`
...
- **Usuario**: `2895884051401+piloto.centro@ingenieria.usac.edu.gt`
...
- **Usuario**: `2895884051401+agente.financiero@ingenieria.usac.edu.gt`
- **Acción**: 
...
- **Usuario (Cliente)**: Accede nuevamente al portal de cliente y sube comprobante de transferencia bancaria (`PENDIENTE`).
...
- **Usuario**: `2895884051401+gerencia@ingenieria.usac.edu.gt`
